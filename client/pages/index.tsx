...
export default function Home(): JSX.Element {
  return (
    <>
      ...
      <main>
        <div style={styles.title} className={homeStyles.title}>
          Using this helps people like you save on food!
        </div>
        <div style={styles.subtitle} className={homeStyles.subtitle}>
